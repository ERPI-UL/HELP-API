                ...
                <div class="bg-white rounded min-w-[12vw] divide-y min-w-0 w-fit" ref="menu">
                    ...
                    <div class="flex md:flex-col md:overflow-x-visible overflow-x-scroll justify-between py-2">
                        <p class="whitespace-nowrap py-1 px-2 mx-4 my-1 rounded-lg text-base font-semibold text-left text-indigo-800 cursor-pointer"
                           ...
                           v-on:click="menu.selectedOption = el.name; selectOption()"
                        ...
                        <div class="md:flex hidden grow m-4 min-h-0 max-h-full max-w-full min-w-0">
                            <div id="loading-zone" class="flex grow">
                                <div class="flex m-auto">
                                    ...
                                    <p class="ml-4 text-xl font-semibold text-indigo-600">{{ User.LANGUAGE.DATA.ACTIONS.LOADING }} ...</p>
                                </div>
                            </div>
...
function noLastSession() {
    ...
    loadingZone.innerHTML = `
        <div class="flex m-auto">
            ...
            <p class="text-2xl font-extrabold text-gray-300 my-auto ml-4">${User.LANGUAGE.DATA.HOME.MESSAGES.NO_LAST_SESSION_FOUND}</p>
        </div>
    `
}
...
function generateChart(data, labels) {
    ...
    const chart = new Chart(canvas, {
        ...
        data: {
            labels: labels,
            datasets: [{
                label: User.LANGUAGE.DATA.STATISTICS.ABS_TIME,
                backgroundColor: a,
                borderColor: a,
                data: data,
                tension: 0.4,
...
const shortcuts = [
    ...
    {
        name: "account",
        title: User.LANGUAGE.DATA.PAGES.ACCOUNT,
        data: [
            {
                icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />`,
                title: User.LANGUAGE.DATA.PROFILE.TITLE,
                description: User.LANGUAGE.DATA.PROFILE.DESCRIPTION,
                redirect: {
                    href: "/profile",
                    label: User.LANGUAGE.DATA.PROFILE.REDIRECT
                }
            },
            {
                ...
                title: User.LANGUAGE.DATA.EASYCONNECT.TITLE,
                description: User.LANGUAGE.DATA.EASYCONNECT.DESCRIPTION,
                redirect: {
                    href: "/easyconnect",
                    label: User.LANGUAGE.DATA.EASYCONNECT.REDIRECT
                }
            },
            {
                ...
                title: User.LANGUAGE.DATA.ADMIN.TITLE,
                description: User.LANGUAGE.DATA.ADMIN.DESCRIPTION,
                redirect: {
                    href: "/admin",
                    label: User.LANGUAGE.DATA.ADMIN.REDIRECT
                }
            }
        ]
    },
    {
        name: "statistics",
        title: User.LANGUAGE.DATA.PAGES.STATISTICS,
        data: [
            {
                ...
                title: User.LANGUAGE.DATA.STATISTICS.PAGES.LEARNING.TITLE,
                description: User.LANGUAGE.DATA.STATISTICS.PAGES.LEARNING.DESCRIPTION,
                redirect: {
                    href: "/statistics#learning",
                    label: User.LANGUAGE.DATA.STATISTICS.PAGES.LEARNING.REDIRECT
                }
            },
            {
                ...
                title: User.LANGUAGE.DATA.STATISTICS.PAGES.TESTING.TITLE,
                description: User.LANGUAGE.DATA.STATISTICS.PAGES.TESTING.DESCRIPTION,
                redirect: {
                    href: "/statistics#testing",
                    label: User.LANGUAGE.DATA.STATISTICS.PAGES.TESTING.REDIRECT
                }
            }
        ]
    },
    {
        ...
        data: [
            ...
            },
            {
                ...
                title: User.LANGUAGE.DATA.SCENARIOS.PAGES.EDIT.TITLE,
                description: User.LANGUAGE.DATA.SCENARIOS.PAGES.EDIT.DESCRIPTION,
                redirect: {
                    href: "/scenarios#editing",
                    label: User.LANGUAGE.DATA.SCENARIOS.PAGES.EDIT.REDIRECT
                }
            },
            {
                icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />`,
                title: User.LANGUAGE.DATA.SCENARIOS.PAGES.CREATE.TITLE,
                description: User.LANGUAGE.DATA.SCENARIOS.PAGES.CREATE.DESCRIPTION,
                redirect: {
                    href: "/scenarios/create",
                    label: User.LANGUAGE.DATA.SCENARIOS.PAGES.CREATE.REDIRECT
                }
            }
        ]
    },
    {
        name: "machines",
        title: User.LANGUAGE.DATA.PAGES.MACHINES,
        data: [
            {
                icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                       <path stroke-linecap="round" stroke-linejoin="round" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />`,
                title: User.LANGUAGE.DATA.MACHINES.PAGES.VIEW.TITLE,
                description: User.LANGUAGE.DATA.MACHINES.PAGES.VIEW.DESCRIPTION,
                redirect: {
                    href: "/machines#all",
                    label: User.LANGUAGE.DATA.MACHINES.PAGES.VIEW.REDIRECT
                }
            },
            {
                icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />`,
                title: User.LANGUAGE.DATA.MACHINES.PAGES.EDIT.TITLE,
                description: User.LANGUAGE.DATA.MACHINES.PAGES.EDIT.DESCRIPTION,
                redirect: {
                    href: "/machines#editing",
                    label: User.LANGUAGE.DATA.MACHINES.PAGES.EDIT.REDIRECT
                }
            },
            {
                icon: `<path stroke-linecap="round" stroke-linejoin="round" d="M12 4v16m8-8H4" />`,
                title: User.LANGUAGE.DATA.MACHINES.PAGES.CREATE.TITLE,
                description: User.LANGUAGE.DATA.MACHINES.PAGES.CREATE.DESCRIPTION,
                redirect: {
                    href: "/machines/create",
                    label: User.LANGUAGE.DATA.MACHINES.PAGES.CREATE.REDIRECT
                }
            }
        ]
    }
